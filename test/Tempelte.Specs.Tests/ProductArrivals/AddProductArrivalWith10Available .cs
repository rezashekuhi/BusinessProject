...
{
    [Scenario("ورود کالا")]
    public class AddProductArrivalWith10Available : BusinessIntegrationTest
    {
        private Group group;
        ...
        [When("تعداد 10 تا به موجودی کالایی " +
        ...
        public void When()
        {
            ...
            var dto = ProductArrivalDtoFactory.Create(product.Id, 10, "123a", "شرکت فپکو");
            sut.Add(dto);
        }

        [Then("یک کالا با عنوان شامپو و موجودی 10 " +
        ...
        public void Then()
        {
            ...
            expectedProductArrival.Number.Should().Be(10);
