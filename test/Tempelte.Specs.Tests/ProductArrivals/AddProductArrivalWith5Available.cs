...
{
    [Scenario("ورود کالا")]
    public class AddProductArrivalWith5Available : BusinessIntegrationTest
    {
        private Group group;
        ...
        [When("تعداد 5 تا به موجودی کالایی " +
        ...
        public void When()
        {
            ...
            var dto = ProductArrivalDtoFactory.Create(product.Id, 5, "123a", "شرکت فپکو");
            sut.Add(dto);
        }

        [Then("یک کالا با عنوان شامپو و موجودی 5 " +
            "و وضعیت آماده سفارش در گروه بهداشتی " +
            "و حداقل موجودی 5 باید در فهرست کالاها " +
            "وجود داشته باشد" +
            "و: یک ورودی کالا برای کالای شامپو" +
            " در تاریخ 1402 / 09 / 19 21:59 " +
            " و تعداد 10 و شماره فاکتور ۱۲۳آ " +
        ...
        public void Then()
        {
            ...
            expectedProductArrival.Number.Should().Be(5);
